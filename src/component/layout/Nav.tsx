...
function Nav() {
  return (
    <nav className=" fixed top-0 left-0 z-[100] w-[50px] h-full">
      <div className="  h-full shadow shadow-black bg-gray-900 text-white text-3xl flex items-center justify-between flex-col py-10 nav-container">
        <img
