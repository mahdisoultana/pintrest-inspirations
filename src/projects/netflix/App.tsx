...
function App({ children }: { children: ReactNode }) {
  ...
  return (
    <>
      <div className="netflix font-Nunito text-white font-light bg-[#181818]">
        ...
        <Header>
          <main className=" w-full opacity-0 h-full justify-between  flex space-x-4 px-1 items-center ">
            {children}
          </main>
        </Header>
      </div>
