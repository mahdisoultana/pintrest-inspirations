    ...
    <div className="bg-black min-h-screen py-10 font-Lora  italic">
      ...
      <section className="grid  gap-8 gap-y-52  ">
        {[
          ...
          { number: 'II', img: '/doubleEffect/6.png' },
          { number: 'III', img: '/doubleEffect/7.png' },
          { number: 'VI', img: '/doubleEffect/8.png' },
        ...
        <p className="text-yellow-700 not-italic capitalize tracking-wider text-center text-xs">
          created by{' '}
          ...
          , images generated by<span className="underline"> midjourney </span>,
          thanks to <span className="underline">codrops</span> help !
        </p>
      </section>
    </div>
  );
